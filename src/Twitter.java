...
class Twitter {
	...
	/**
	 * @param userId
	 * @param tweetId Follows ourselves and pushes the tweet to our list with time. TC: O(1)
	 **/
	...
	/**
	 * @param userId
	 * @return Use Priority Queue to iterate over all the following list and their tweets to get latest 10 tweets. TC: O(NlogN)
	 **/
	 ...
	 * @param followerId
	 * @param followeeId 
	 * Push the follower and followee to the map to track the list of following people for each person.
	 **/
